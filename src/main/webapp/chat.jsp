          ...
          <div id = "chat" class="direct-chat-messages">
            ...
            <!-- Message. Default to the left -->
              ...
              <div class="direct-chat-msg left">
                <div class="direct-chat-info clearfix">
                  <!-- get your name -->
                  <span class="direct-chat-name pull-left"><strong><a href="/profile?profilepage=<%= author %>"><%= author %></a></strong></span>
            ...
            <!-- Message to the right -->
              <div class="direct-chat-msg right">
                <div class="direct-chat-info clearfix">
                  <span class="direct-chat-name pull-right"><strong><a href="/profile?profilepage=<%= author %>"><%= author %></a></strong></span>
                </div> <!-- /.direct-chat-info -->
                <div class="direct-chat-text">
                   <%= message.getContent() %>
                </div><!-- /.direct-chat-text -->
